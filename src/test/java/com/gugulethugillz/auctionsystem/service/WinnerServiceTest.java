...
import com.gugulethugillz.auctionsystem.winner.service.impl.WinnerServiceImpl;
...
public class WinnerServiceTest {
    ...
    public void givenExistingWinners_whenFindByUsername_thenShouldReturnNonEmptyList() throws Exception {
        ...
        List<Winner> winners = winnerService.findByUsername("gugulethu@gmail.com");
